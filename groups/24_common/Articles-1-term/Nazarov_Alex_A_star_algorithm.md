...
https://www.redblobgames.com/pathfinding/a-star/introduction.html – самое адекватно интуитивное объяснение A*

https://en.wikipedia.org/wiki/A*_search_algorithm – непонятно, но содержательно

https://ru.wikipedia.org/wiki/Алгоритм_Дейкстры – здесь про Дейкстру хорошо

https://www.geeksforgeeks.org/artificial-intelligence/a-algorithm-and-its-heuristic-search-strategy-in-artificial-intelligence/ – здесь про реализацию A* больше
